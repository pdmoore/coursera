...
// Answer is 17, takes about 8 minutes to run on MacBook
//        int[][] arr = getArray( "simpleCut.txt" );
//        int[][] arr = getArray( "simCut2.txt" );
//        int[][] arr = getArray( "simCut1.txt" );
//        int[][] arr = getArray( "longCut.txt" );
//        int[][] arr = getArray( "zeroCut.txt" );
